            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('admin.categories.create') }}" class="group px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl hover:shadow-lg hover:shadow-cyan-500/30 transition-all transform hover:scale-105 font-semibold font-mono flex items-center gap-2 text-white font-bold">
        ...
        @if($categories->isEmpty())
            <div class="group relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl border border-blue-500/20 p-12 text-center shadow-xl">
                ...
                <div class="relative z-10">
                    ...
                    <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl hover:shadow-lg hover:shadow-cyan-500/30 transition-all transform hover:scale-105 font-semibold font-mono text-white font-bold">
